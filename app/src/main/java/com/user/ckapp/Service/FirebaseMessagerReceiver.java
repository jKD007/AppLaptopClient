package com.user.ckapp.Service;
...
import com.user.ckapp.MainActivity;
...
public class FirebaseMessagerReceiver extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage message) {
        ...
        private void showNotification(String title, String body) {
            ...
            builder = builder.setContent(customerView(title,body));
    ...
    private RemoteViews customerView(String title, String body){
        RemoteViews remoteViews = new RemoteViews(getApplicationContext().getPackageName(), R.layout.notification);
        remoteViews.setTextViewText(R.id.title_noti, title);
        remoteViews.setTextViewText(R.id.body_noti, body);
        remoteViews.setImageViewResource(R.id.imgnoti, R.drawable.ic_cart_24);
        return remoteViews;
    }
}
