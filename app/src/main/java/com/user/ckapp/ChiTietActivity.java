...
public class ChiTietActivity extends AppCompatActivity {
    TextView tensp, giasp, mota, giagoc;
    Button btnthem;
    ...
    private void initData() {
        ...
        giagoc.setText("Giá gốc: " + decimalFormat.format(Double.parseDouble(sanPhamMoi.getGiagoc())) + "đ");
        giagoc.setPaintFlags(giagoc.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
        giasp.setText("Giá khuyến mãi: " + decimalFormat.format(Double.parseDouble(sanPhamMoi.getGiasp())) + "đ");
    ...
    private void initView() {
        ...
        giagoc = findViewById(R.id.txtgiagoc);
