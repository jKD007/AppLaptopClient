...
import com.user.ckapp.Interface.IImageClickListener;
import com.user.ckapp.R;
import com.user.ckapp.model.EventBus.TinhTongEvent;
...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.MyViewHodler> {
    Context context;
